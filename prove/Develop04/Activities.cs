...
public class Activity
{
    ...
    {
        Console.WriteLine($"You are welcome to the {_name}.");
        Console.WriteLine();
    ...
    {
        Console.WriteLine();
        Console.Write("Let start how long, in seconds, do you like for your session to last? ");
    ...
    public void EndActivity()
    {
        Console.WriteLine();
        Console.WriteLine();
        Console.WriteLine($"Congrats, You Well Done!!");
        GenerateSpinner(5);
        Console.WriteLine();
    ...
    {
        Console.Clear();
        Console.WriteLine("Please Wait, and Get Ready>...");
        GenerateSpinner(5);
    }
